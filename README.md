...
[![Release](https://img.shields.io/github/release/ScivizLabVienna/HandsomeTello/releases/latest)?label=release&color=brightgreen)](https://github.com/ScivizLabVienna/HandsomeTello/releases/)
